...
var LR_ssl = 0;
var LR_2abb3='7EEEB4EB44C9472D94B1CACDF29D4C5F';var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_sysurl = 'http://kau.zoossoft.net/';
var LR_js_pm = 'd';
var LR_imgurl = 'http://kau.zoossoft.net/';
var LR_4199b=LR_2abb3.replace(/1/g,'3').replace(/0/g,'2');var LR_isMobile = 1;
var LR_websiteid = 'KAU83879408';
LR_4199b=LR_4199b.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_DGJJ=LR_4199b.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	var _lr_helpalt_on=unescape("");
	var _lr_helpsrc_on=unescape("http%3a%2f%2fkau.zoossoft.net%2fsite%2f83879408%2fmonline_cn.png");
	var _lr_helpalt_of=unescape("");
	var _lr_helpsrc_of=unescape("http%3a%2f%2fkau.zoossoft.net%2fsite%2f83879408%2fmoffline_cn.png");
	...
	var _lr_mobileinviteimgsrc=unescape("http%3a%2f%2fkau.zoossoft.net%2fsite%2f83879408%2fminvite_cn.png");
	var LR_pm001=0;
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&HFJK='+LR_DGJJ;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		document.write('<link href="http://kau.zoossoft.net/js/JS5_1.css" rel="stylesheet" type="text/css" />');
var LR_MCount1 = 5000; 
...
window.addEventListener('message', function (e) {
         ...
         function LR_inputFocus() {
             ...
             setTimeout("window.scrollTo(0, 9999);", 300);
         }
