var LR_5d8bd='DBED2E6D4E964A319F1CEDBED8575695';var LiveReceptionCode_isonline = 1;
var LR_ssl = 0;
var LR_isMobile = 0;
LR_5d8bd=((4+1).toString()+LR_5d8bd+(4*1).toString());var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LR_websiteid = 'KAU83879408';
var LR_imgurl = 'http://kau.zoossoft.net/';
LR_5d8bd=((5+2).toString()+LR_5d8bd+(5*2).toString());LR_5d8bd=((5+3).toString()+LR_5d8bd+(5*3).toString());var LR_sysurl = 'http://kau.zoossoft.net/';
var LR_siteid = '83879408';
var LR_lng = 'cn';
var LR_lxurl = 'http://kau.zoossoft.net/';
var LR_b2840=LR_5d8bd.replace(/4/g,'8').replace(/5/g,'3');var LR_LONF=LR_b2840.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	LR_hasInstall=0;
	var LR_ivite_img='http://swt.027imei.com/js/tj_blue/p.gif';
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&GLFD='+LR_LONF;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://kau.zoossoft.net/js/JS5.css" rel="stylesheet" type="text/css" />');
...
function minichathtmlF(islrminimin) {if(!minichathtml1)return minichathtml(islrminimin);return '<div style="'+(LiveReceptionCode_isonline?'width:400px; height:400px;':'width:420px; height:463px;')+(islrminimin?'display:none;':'')+'" id="LRMINIWIN"><div  id="LRMINIWIN0" style="z-index: 2147483647; position: absolute; height: 30px; overflow: hidden; display: block;right:0"><span style="float:left;clear:none; width:103px;height:20px; overflow:hidden; margin:0 5px;"></span><span style="'+(LR_pm007?'':'display:none;')+'CURSOR:pointer;float:right;clear:none; width:20px;height:20px; margin:6px 2px 0 0; overflow:hidden;" onclick="lr_closemini(1);"><img style="cursor:pointer;" src="' + LR_imgurl+'lr/mini_new/close.png" border="0"></span><span style="CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:6px 2px 0 0;" onclick="lrminiMin();"><img src="' + LR_imgurl+'lr/mini_new/da1.png" style="cursor:pointer;"  border="0"></span><span style="CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:6px 2px 0 0;" onclick="openZoosUrl(\'bchatwin\');lr_hidemini();"><img src="' + LR_imgurl+'lr/mini_new/da.png" style="cursor:pointer;"  border="0"></span><span style="CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:6px 2px 0 0;" onclick="lrmove();"><img src="' + LR_imgurl+'lr/mini_new/jiantou.png" style="cursor:pointer;"  border="0"></span></div><iframe id="LR_miniframe" name="LR_miniframe" width="100%" height="'+(LiveReceptionCode_isonline?'400':'463')+'px" frameborder="0" scrolling="No" allowtransparency="true" ' + if_src() +'></iframe></div>';}
        function minibarhtmlF(islrminimin) {if(!minichathtml1)return minibarhtml(islrminimin);return '<div id="LRMINIBar" class="LR_Mini_ICON" style="'+(!islrminimin?'display:none;':'block')+';" onclick="lrminiMax();"><a class="LR-BTN" style="background-color: '+LR_pm006+';"><span class="LR-ICON LR-ICON-CHAT1" id="LR-BTN-ICON"></span><span id="LR-CIRCLE" style="display:none;background-color: '+LR_pm006+';"></span> </a><div id="LR-BUBBLE" style="display:none;width:400px;margin-right:34px;cursor:pointer"><span class="LR-ICON" id="LR-BUBBLE-CLOSE" onclick="return closebarhtml(event);"></span><div id="LR-BUBBLE-INSIDE"><div id="LR-BUBBLE-title"><img id="LR-BUBBLE-AVATAR" src=""><span id="LR-BUBBLE-NAME"></span></div><div id="LR-BUBBLE-MSG"></div></div></div></div>';}
